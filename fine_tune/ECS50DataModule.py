...
class ECS50DataModule(LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        data_frame = data_frame.sample(frac=1).reset_index(drop=True) # shuffle the data frame
    ...
    def train_dataloader(self):
        ...
        train_df = AudioDataset(root_dir=self.root_dir, 
    ...
    def val_dataloader(self):
        ...
        val_df = AudioDataset(root_dir=self.root_dir, 
